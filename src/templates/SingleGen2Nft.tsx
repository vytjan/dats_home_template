...
const SingleGen2Nft = () => {
  ...
  return (
    <Section>
      <Meta
        title={AppConfig.gen2Title}
        description={AppConfig.gen2CollDescription}
      />
      <HeaderMenu></HeaderMenu>
      <div className="flex justify-center">
        {meta.length < 1 ? (
          <h1 className="px-20 py-10 text-2l font-semibold text-center">
            Loading Gen2 Daturian
          </h1>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 gap-4">
            <div className="sm:col-span-4 lg:col-span-1">
              <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-1 gap-4 pt-4 ">
                ...
                <div className="bg-primary-100 content-gallery rounded-xl overflow-hidden lg:col-span-1 sm:col-span-1">
                  <div className="p-4 ">
                    <p className="text-2l font-semibold">{`Greenhouse #${meta.tokenId}`}</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="grid sm:grid-cols-2 xs:grid-cols-1 gap-4">
                    <div className="p-4 col-span-1">
                      <h1>
                        ...
                        {meta.data.attributes[5].value.split(' x ')[0]}
                      </h1>
                      <br />
                    ...
                    <div className="p-4 col-span-1">
                      <img
                        ...
                        src={`${
                          router.basePath
                        }/assets/images/gallery/families/${meta.data.attributes[5].value
                          .split(' x ')[0]
                          .split(' ')
                          .join('-')}.png`}
                      />
                  ...
                  <div className="grid sm:grid-cols-2 xs:grid-cols-1 gap-4">
                    <div className="p-4 col-span-1">
                      <img
                        ...
                        src={`${
                          router.basePath
                        }/assets/images/gallery/locations/${meta.data.attributes[3].value
                          .split(' ')
                          .join('-')}.png`}
                        alt="location.png"
                      />
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4">
                ...
                <div className="bg-primary-100 content-gallery rounded-xl overflow-hidden lg:col-span-2 sm:col-span-4">
                  <div className="grid sm:grid-cols-2 xs:grid-cols-1 gap-4">
                    <div className="p-4 col-span-2">
                      <h1>
                        {meta.data.attributes[12].trait_type}:{' '}
                        {meta.data.attributes[12].value}
                      </h1>
                      <br />
