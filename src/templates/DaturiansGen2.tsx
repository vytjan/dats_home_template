    ...
    <Section>
      ...
      <div className="flex justify-center">
        <div className="grid-cols-1 gap-5 max-auto px-3">
          <h1 className="text-3xl text-center">{AppConfig.gen2Title}</h1>
            ...
            <div className="search-field sm:grid-cols-5 md:grid-cols-3 gap-1">
              ...
              >
                <input
                  ...
                  placeholder="Search for Daturian Gen2 ID"
                  value={query}
            ...
            <>
              {nfts.nftData.length < 1 ? (
                <h1 className="px-20 py-10 text-3xl">
                  No Gen2 Daturians match your search. Sorry...
                </h1>
              ) : (
                <div>
...
export default DaturiansGen2Collection;
