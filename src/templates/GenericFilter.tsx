...
export default function GenericFilter(props: GenericFilterProps) {
  ...
  return (
    <div className="w-60 generic-filter">
      <Listbox
      ...
      >
        <div className="mt-1">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="relative mt-1 max-h-60 w-full overflow-auto rounded-md bg-secondary-100 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
