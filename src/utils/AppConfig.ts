export const AppConfig = {
  ...
  seedTitle: 'Seed Barrel V2',
  seedDescription: 'Upload your flora/fungi to take a part in Seed Barrel V2.',
  aboutTitle: 'Daturians NFT Home',
  aboutDescription: 'Everything there is to know about Daturians NFT',
  galleryTitle: 'Daturians NFT Gallery',
  galleryDescription: 'Explore the Datura world!',
